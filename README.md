...
[![GitHub contributors](https://img.shields.io/github/contributors/davidsonfellipe/awesome-wpo.svg)](https://github.com/davidsonfellipe/awesome-wpo/graphs/contributors) ⭐ 9,063 | 🐛 29 | 📅 2026-07-28
...
* [web-quality-audit](https://github.com/addyosmani/web-quality-skills#web-quality-audit) ⭐ 2,760 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - Comprehensive quality review across all categories.
* [core-web-vitals](https://github.com/addyosmani/web-quality-skills#core-web-vitals) ⭐ 2,760 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - LCP, INP, and CLS specific optimizations.
* [accessibility](https://github.com/addyosmani/web-quality-skills#accessibility) ⭐ 2,760 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - WCAG compliance, screen reader support, and keyboard navigation.
* [performance](https://github.com/addyosmani/web-quality-skills#performance) ⭐ 2,760 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - Loading speed, runtime efficiency, and resource optimization.
* [best-practices](https://github.com/addyosmani/web-quality-skills#best-practices) ⭐ 2,760 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - Security, modern APIs, and code quality patterns.
...
* [BundleStats](https://github.com/relative-ci/bundle-stats) ⭐ 672 | 🐛 47 | 🌐 TypeScript | 📅 2026-09-07 - Generate bundle report(bundle size, assets, modules, packages) and compare the results between different builds.
...
* [jsDelivr](https://github.com/jsdelivr/jsdelivr) ⭐ 6,362 | 🐛 31 | 🌐 JavaScript | 📅 2026-06-27 - Similar to Google Hosted Libraries, jsDelivr is an open-source CDN that allows developers to host their own projects and anyone to link to our hosted files on their sites.
...
* [Lighthouse](https://github.com/GoogleChrome/lighthouse) ⭐ 30,743 | 🐛 464 | 🌐 JavaScript | 📅 2026-09-06 - Audits Core Web Vitals in lab conditions (see [Analyzers](#analyzers)).
...
* [Sharp](https://github.com/lovell/sharp) ⭐ 32,638 | 🐛 117 | 🌐 JavaScript | 📅 2026-09-07 - The typical use case for this high-speed Node.js module is to convert large images of many formats to smaller, web-friendly JPEG, PNG, and WebP images of varying dimensions.
...
* [Guess.js](https://github.com/guess-js/guess) ⭐ 7,119 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-03 - Predictive prefetching and performance optimization using analytics and machine learning.
...
* [Html-minifier](https://github.com/deanhume/html-minifier) ⭐ 142 | 🐛 0 | 🌐 C# | 📅 2026-09-03 - A simple Windows command-line tool to minify your HTML, Razor views & Web Forms views.
...
* [Fontaine](https://github.com/unjs/fontaine) ⭐ 1,986 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-07 - Automatic font fallback based on font metrics to reduce Cumulative Layout Shift (CLS) caused by web font loading.
* [TMI](https://github.com/addyosmani/tmi) ⭐ 1,614 | 🐛 6 | 🌐 JavaScript | 📅 2017-02-14 - Too Many Images: discover your image weight on the web.
* [uCSS](https://github.com/oyvindeh/ucss) ⭐ 1,608 | 🐛 3 | 🌐 JavaScript | 📅 2017-01-26 - Crawls large sites to find unused CSS selectors (does not remove unused CSS).
...
* [SVGO](https://github.com/svg/svgo) ⭐ 22,664 | 🐛 261 | 🌐 JavaScript | 📅 2026-08-27 - Node.js-based optimizer for SVG vector graphics.
...
For contributing, please check [contributing.md](contributing.md), then [open an issue](https://github.com/davidsonfellipe/awesome-wpo/issues) ⭐ 9,063 | 🐛 29 | 📅 2026-07-28 and/or a [pull request](https://github.com/davidsonfellipe/awesome-wpo/pulls) ⭐ 9,063 | 🐛 29 | 📅 2026-07-28.
