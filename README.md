...
[![GitHub contributors](https://img.shields.io/github/contributors/davidsonfellipe/awesome-wpo.svg)](https://github.com/davidsonfellipe/awesome-wpo/graphs/contributors) ⭐ 9,083 | 🐛 30 | 📅 2026-07-28
...
* [web-quality-audit](https://github.com/addyosmani/web-quality-skills#web-quality-audit) ⭐ 2,807 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - Comprehensive quality review across all categories.
* [core-web-vitals](https://github.com/addyosmani/web-quality-skills#core-web-vitals) ⭐ 2,807 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - LCP, INP, and CLS specific optimizations.
* [accessibility](https://github.com/addyosmani/web-quality-skills#accessibility) ⭐ 2,807 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - WCAG compliance, screen reader support, and keyboard navigation.
* [performance](https://github.com/addyosmani/web-quality-skills#performance) ⭐ 2,807 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - Loading speed, runtime efficiency, and resource optimization.
* [best-practices](https://github.com/addyosmani/web-quality-skills#best-practices) ⭐ 2,807 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - Security, modern APIs, and code quality patterns.
...
* [Yandex.Tank](https://github.com/yandex/yandex-tank) ⭐ 2,597 | 🐛 86 | 🌐 Python | 📅 2026-09-18 - An extensible open-source load testing tool for advanced Linux users which is especially good as a part of an automated load testing suite.
...
* [Redirect Checker](https://github.com/brancogao/redirect-checker) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-17 - Analyze HTTP redirect chains, detect loops, and measure performance impact on page load times.
...
* [PSI](https://github.com/GoogleChromeLabs/psi) ⚠️ Archived - PageSpeed Insights for Node.js - with reporting.
...
* [Webpack bundle analyzer](https://github.com/webpack/webpack-bundle-analyzer) ⭐ 12,657 | 🐛 26 | 🌐 JavaScript | 📅 2026-09-17 - Webpack plugin and CLI utility that represents bundle content as a convenient interactive zoomable treemap.
...
* [Compression Webpack plugin](https://github.com/webpack/compression-webpack-plugin) ⭐ 1,425 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-18 - Prepare compressed versions of assets to serve them with Content-Encoding.
* [BundleStats](https://github.com/relative-ci/bundle-stats) ⭐ 673 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-18 - Generate bundle report(bundle size, assets, modules, packages) and compare the results between different builds.
...
* [Stats.js](https://github.com/mrdoob/stats.js) ⭐ 9,151 | 🐛 23 | 🌐 JavaScript | 📅 2024-10-11 - This class provides a simple info box that will help you monitor your code performance.
* [Memory-stats.js](https://github.com/paulirish/memory-stats.js) ⭐ 2,090 | 🐛 3 | 🌐 JavaScript | 📅 2015-07-03 - Minimal monitor for JS Heap Size via performance memory.
* [Timing.js](https://github.com/addyosmani/timing.js) ⭐ 1,476 | 🐛 10 | 🌐 JavaScript | 📅 2020-04-02 - Small helpers for working with the Navigation Timing API to identify where your application is spending its time. Useful as a standalone script, DevTools snippet, or bookmarklet.
* [JSPerf](https://github.com/jsperf/jsperf.com) ⭐ 1,295 | 🐛 47 | 🌐 JavaScript | 📅 2021-06-23 - Create and share test cases comparing JavaScript snippet performance via benchmarks. `Follow this issue for updates: https://github.com/jsperf/jsperf.com/issues/537`.
* [CSS-perf](https://github.com/mdo/css-perf) ⚠️ Archived - Completely unscientific way of testing CSS performance. Most of these tests will revolve around methodologies and techniques for determining effective CSS architecture. Put another way, I want to know what works best given a particular comparison of CSS strategies.
* [Matcha](https://github.com/logicalparadox/matcha) ⭐ 562 | 🐛 17 | 🌐 JavaScript | 📅 2020-09-04 - Lets you design experiments that measure the performance of your code. Each bench should focus on a specific point of impact in your application.
* [JSlitmus](https://github.com/broofa/jslitmus) ⚠️ Archived - Lightweight tool for creating ad-hoc JavaScript benchmark tests.
* [PHPench](https://github.com/mre/PHPench) ⭐ 54 | 🐛 3 | 🌐 PHP | 📅 2019-10-21 - Graphical output for PHP benchmarks: plot any function's runtime in real time with GnuPlot and export an image of the result.
* [php-bench](https://github.com/jacobbednarz/php-bench) ⭐ 15 | 🐛 0 | 🌐 PHP | 📅 2015-02-02 - Benchmark and profile PHP code blocks whilst measuring the performance footprint.
* [PerfTests](https://github.com/kogarashisan/PerfTests) ⭐ 1 | 🐛 1 | 🌐 JavaScript | 📅 2015-05-02 - Performance tests of JavaScript inheritance models.
...
* [PerfMap](https://github.com/zeman/perfmap) ⭐ 3,763 | 🐛 12 | 🌐 JavaScript | 📅 2017-05-12 - A bookmarklet to create a frontend performance heatmap of resources loaded in the browser using the Resource Timing API.
* [Performance-Bookmarklet](https://github.com/micmro/performance-bookmarklet) ⭐ 1,152 | 🐛 15 | 🌐 JavaScript | 📅 2023-03-03 - Analyze the current page through the Resource Timing API, Navigation Timing API and User-Timing - Sort of a light live WebPageTest. As [Firefox Add-on](https://addons.mozilla.org/en-US/firefox/addon/performance-analyser/?src=cb-dl-created) under the name Performance-Analyser.
* [DOM Monster](https://github.com/madrobby/dom-monster) ⭐ 555 | 🐛 21 | 🌐 JavaScript | 📅 2022-04-15 - A cross-platform, cross-browser bookmarklet that will analyze the DOM & other features of the page you're on, and give you its bill of health.
...
* [jsDelivr](https://github.com/jsdelivr/jsdelivr) ⭐ 6,380 | 🐛 33 | 🌐 JavaScript | 📅 2026-06-27 - Similar to Google Hosted Libraries, jsDelivr is an open-source CDN that allows developers to host their own projects and anyone to link to our hosted files on their sites.
...
* [Lighthouse](https://github.com/GoogleChrome/lighthouse) ⭐ 30,797 | 🐛 463 | 🌐 JavaScript | 📅 2026-09-18 - Audits Core Web Vitals in lab conditions (see [Analyzers](#analyzers)).
* [web-vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,617 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-14 - Small library to accurately measure Core Web Vitals (LCP, FID, CLS, INP, TTFB) in the browser.
* [Lighthouse CI](https://github.com/GoogleChrome/lighthouse-ci) ⭐ 7,090 | 🐛 234 | 🌐 JavaScript | 📅 2026-03-27 - Run Lighthouse in CI to enforce Core Web Vitals budgets on every commit.

## Extensions

* [Browser Calories](https://github.com/zenorocha/browser-calories) ⭐ 129 | 🐛 3 | 🌐 JavaScript | 📅 2016-05-30 - The easiest way to measure your performance budget.

## Generators

* [Glue](https://github.com/jorgebastida/glue) ⭐ 2,530 | 🐛 69 | 🌐 Python | 📅 2022-11-29 - A simple command-line tool to generate CSS sprites.
* [Grunt-spritesmith](https://github.com/twolfson/grunt-spritesmith) ⭐ 1,129 | 🐛 2 | 🌐 JavaScript | 📅 2022-04-27 - Grunt task for converting a set of images into a sprite sheet and corresponding CSS variables.
...
* [Assetgraph-sprite](https://github.com/assetgraph/assetgraph-sprite) ⭐ 36 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-18 - Assetgraph transform for auto-generating sprites based on the CSS dependency graph.
...
* [SvgToCSS](https://github.com/kajyr/SvgToCSS) ⚠️ Archived - Optimizes and renders SVG files in CSS / Sass sprites.
...
* [Sharp](https://github.com/lovell/sharp) ⭐ 32,693 | 🐛 124 | 🌐 JavaScript | 📅 2026-09-13 - The typical use case for this high-speed Node.js module is to convert large images of many formats to smaller, web-friendly JPEG, PNG, and WebP images of varying dimensions.
* [Gm](https://github.com/aheckmann/gm) ⭐ 6,974 | 🐛 366 | 🌐 JavaScript | 📅 2025-02-25 - GraphicsMagick and ImageMagick for Node.js.
* [mozjpeg](https://github.com/mozilla/mozjpeg) ⭐ 5,724 | 🐛 104 | 🌐 C | 📅 2025-06-23 - Improved JPEG encoder.
* [Imagemin](https://github.com/imagemin/imagemin) ⭐ 5,720 | 🐛 81 | 🌐 JavaScript | 📅 2025-03-07 - Minify images seamlessly with Node.js.
...
* [Gulp-imagemin](https://github.com/sindresorhus/gulp-imagemin) ⭐ 1,902 | 🐛 23 | 🌐 JavaScript | 📅 2026-09-18 - Minify PNG, JPEG, GIF and SVG images with imagemin for Gulp.
* [Jpegoptim](https://github.com/tjko/jpegoptim) ⭐ 1,816 | 🐛 11 | 🌐 C | 📅 2026-09-16 - Utility to optimize/compress JPEG files.
...
* [Leanify](https://github.com/JayXon/Leanify) ⭐ 853 | 🐛 20 | 🌐 C++ | 📅 2026-06-05 - Lightweight lossless file minifier/optimizer.
...
* [Optimizt](https://github.com/343dev/optimizt) ⭐ 183 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-12 - CLI image optimization tool. It can compress PNG, JPEG, GIF and SVG lossy and lossless, and also create AVIF and WebP versions for raster images.
* [Grunt-WebP](https://github.com/somerandomdude/grunt-webp) ⭐ 117 | 🐛 4 | 🌐 JavaScript | 📅 2016-02-21 - Convert your images to WebP format.
* [Grunt-smushit](https://github.com/heldr/grunt-smushit) ⭐ 84 | 🐛 0 | 🌐 JavaScript | 📅 2016-03-27 - Grunt plugin to remove unnecessary bytes of PNG and JPG using Yahoo Smushit.
* [Gulp-smushit](https://github.com/heldr/gulp-smushit) ⭐ 32 | 🐛 3 | 🌐 JavaScript | 📅 2018-03-08 - Gulp plugin to optimize PNG and JPG using Yahoo Smushit. Made on top of smosh.
* [Tapnesh-CLI](https://github.com/JafarAkhondali/Tapnesh) ⭐ 21 | 🐛 0 | 🌐 Shell | 📅 2020-07-21 - Tapnesh is a CLI tool that will optimize all your images in parallel easily and efficiently!
...
* [quicklink](https://github.com/GoogleChromeLabs/quicklink) ⭐ 11,295 | 🐛 38 | 🌐 JavaScript | 📅 2026-09-01 - Prefetch links in the viewport (via Intersection Observer) to make future navigations faster.
* [lozad.js](https://github.com/ApoorvSaxena/lozad.js) ⭐ 7,493 | 🐛 68 | 🌐 JavaScript | 📅 2025-11-18 - Highly performant, light \~0.9kb, and configurable lazy loader in pure JS with no dependencies for responsive images, iframes, and more.
...
* [Guess.js](https://github.com/guess-js/guess) ⭐ 7,119 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-18 - Predictive prefetching and performance optimization using analytics and machine learning.
* [InstantClick](https://github.com/dieulot/instantclick) ⭐ 5,484 | 🐛 55 | 🌐 JavaScript | 📅 2018-06-06 - Preloads pages on hover so in-site links feel instant.
...
* [JIT](https://github.com/shootaroo/jit-grunt) ⭐ 503 | 🐛 11 | 🌐 JavaScript | 📅 2018-05-11 - A JIT (Just In Time) plugin loader for Grunt. The load time of Grunt does not slow down even if there are many plugins.
* [prerender.js](https://github.com/genderev/prerender.js) ⭐ 411 | 🐛 1 | 🌐 JavaScript | 📅 2020-10-01 - Preloads pages and assets ahead of navigation for faster page transitions.
* [Defer.js](https://github.com/wessman/defer.js) ⭐ 68 | 🐛 1 | 🌐 JavaScript | 📅 2013-04-06 - Async Everything: Make the meat of your pages load faster with this JS morsel.
...
* [Phantomas](https://github.com/macbre/phantomas) ⭐ 2,261 | 🐛 65 | 🌐 JavaScript | 📅 2026-09-16 - PhantomJS-based web performance metrics collector and monitoring tool.
...
* [Telescope](https://github.com/cloudflare/telescope) ⭐ 305 | 🐛 66 | 🌐 TypeScript | 📅 2026-09-18 - Cross-browser web performance testing CLI and library built on Playwright; collects HAR, Web Vitals, resource timing, console logs, screenshots, and filmstrip across Chrome, Firefox, Safari, and Edge.
...
* [Perfjankie](https://www.npmjs.com/package/perfjankie) - Runtime Browser Performance regression suite ([Demo](https://github.com/asciidisco/perfjankie-test) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2014-10-16).
...
* [Terser](https://github.com/terser/terser) ⭐ 9,339 | 🐛 362 | 🌐 JavaScript | 📅 2026-09-13 - Modern JavaScript minifier and compressor; successor to UglifyJS with ES6+ support.
* [HTMLMinifier](https://github.com/kangax/html-minifier) ⭐ 5,035 | 🐛 107 | 🌐 JavaScript | 📅 2026-03-26 - Highly configurable, well-tested, JavaScript-based HTML minifier with lint-like capabilities.
* [Clean-css](https://github.com/clean-css/clean-css) ⭐ 4,200 | 🐛 46 | 🌐 JavaScript | 📅 2024-10-18 - A fast, efficient, and well-tested CSS minifier for node.js.
...
* [CSSO](https://github.com/css/csso) ⭐ 3,784 | 🐛 103 | 🌐 JavaScript | 📅 2024-06-21 - CSS minimizer unlike others. In addition to usual minification techniques, it can perform structural optimization of CSS files, resulting in smaller file size compared to other minifiers.
...
* [Django-pipeline](https://github.com/jazzband/django-pipeline) ⭐ 1,539 | 🐛 157 | 🌐 Python | 📅 2026-08-15 - Pipeline is an asset packaging library for Django, providing both CSS and JavaScript concatenation and compression, built-in JavaScript template support, and optional data-URI image and font embedding.
...
* [Gulp-uncss](https://github.com/ben-eb/gulp-uncss) ⚠️ Archived - A gulp task for removing unused CSS from your projects.
* [Grunt-contrib-concat](https://github.com/gruntjs/grunt-contrib-concat) ⭐ 797 | 🐛 45 | 🌐 JavaScript | 📅 2026-09-13 - A Grunt plugin to concatenate files.
* [Grunt-contrib-cssmin](https://github.com/gruntjs/grunt-contrib-cssmin) ⭐ 788 | 🐛 28 | 🌐 JavaScript | 📅 2026-03-25 - CSS Minifier for Grunt.
* [JShrink](https://github.com/tedious/JShrink) ⭐ 766 | 🐛 14 | 🌐 PHP | 📅 2025-11-20 - PHP class that minifies JavaScript for faster delivery to the client.
* [Gulp-htmlmin](https://github.com/jonschlinkert/gulp-htmlmin) ⭐ 722 | 🐛 7 | 🌐 HTML | 📅 2019-11-08 - A gulp plugin to minify HTML that uses HTMLMinifier.
...
* [Html-minifier](https://github.com/deanhume/html-minifier) ⭐ 142 | 🐛 5 | 🌐 C# | 📅 2026-09-16 - A simple Windows command-line tool to minify your HTML, Razor views & Web Forms views.
...
* [Grunt-cssshrink](https://github.com/JohnCashmore/grunt-cssshrink) ⭐ 29 | 🐛 0 | 🌐 JavaScript | 📅 2016-02-20 - This is just a grunt wrapper for CSS Shrink.
* [Gulp-cssshrink](https://github.com/torrottum/gulp-cssshrink) ⚠️ Archived - Shrinks CSS files using cssshrink for Gulp.
* [HTML\_minifier](https://github.com/stereobooster/html_minifier) ⭐ 12 | 🐛 2 | 🌐 JavaScript | 📅 2016-06-01 - Ruby wrapper for kangax html-minifier.
* [Prettyugly](https://github.com/stoyan/prettyugly) ⭐ 6 | 🐛 1 | 🌐 JavaScript | 📅 2014-06-24 - Uglify (strip spaces) or prettify (add consistent spaces) CSS code.
...
* [react-virtualized](https://github.com/bvaughn/react-virtualized) ⭐ 27,072 | 🐛 0 | 🌐 JavaScript | 📅 2025-01-20 - React components for efficiently rendering large lists and tabular data by virtualizing visible rows.
* [Lazysizes](https://github.com/aFarkas/lazysizes) ⭐ 17,713 | 🐛 209 | 🌐 JavaScript | 📅 2024-04-03 - High-performance lazy loader for images (responsive and normal), iframes, and scripts, that detects any visibility changes triggered through user interaction, CSS or JavaScript without configuration.
* [Critical](https://github.com/addyosmani/critical) ⭐ 10,276 | 🐛 36 | 🌐 JavaScript | 📅 2026-09-13 - Extract & Inline Critical-path CSS in HTML pages (alpha).
* [Fontaine](https://github.com/unjs/fontaine) ⭐ 1,990 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-18 - Automatic font fallback based on font metrics to reduce Cumulative Layout Shift (CLS) caused by web font loading.
...
* [Csscolormin](https://github.com/stoyan/csscolormin) ⭐ 13 | 🐛 0 | 🌐 JavaScript | 📅 2019-02-05 - Utility that minifies CSS colors, example: min("white"); // minifies to "#fff".
...
* [SVGO](https://github.com/svg/svgo) ⭐ 22,682 | 🐛 272 | 🌐 JavaScript | 📅 2026-08-27 - Node.js-based optimizer for SVG vector graphics.
...
* [Grunt-svgmin](https://github.com/sindresorhus/grunt-svgmin) ⭐ 434 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-18 - Minify SVG using SVGO for Grunt.
...
* [Polymer Bundler](https://github.com/Polymer/tools/tree/master/packages/bundler) ⭐ 437 | 🐛 870 | 🌐 TypeScript | 📅 2026-06-21 - Polymer-bundler is a library for packaging project assets for production to minimize network round-trips.
* [Gulp-vulcanize](https://github.com/sindresorhus/gulp-vulcanize) ⚠️ Archived - Concatenate a set of Web Components into one file that use Vulcanize.

## Web server Benchmarks

* [wrk](https://github.com/wg/wrk) ⭐ 40,406 | 🐛 203 | 🌐 C | 📅 2023-12-30 - A HTTP benchmarking tool (with optional Lua scripting for request generation, response processing, and custom reporting).
...
* [HTTPerf.py](https://github.com/jmervine/httperfpy) ⭐ 11 | 🐛 0 | 🌐 Python | 📅 2014-12-17 - Python Port of HTTPerf.rb.
* [PHP-httperf](https://github.com/jmervine/php-httperf) ⭐ 6 | 🐛 0 | 🌐 PHP | 📅 2014-04-28 - PHP Port of HTTPerf.rb.
* [Gohttperf](https://github.com/jmervine/gohttperf) ⭐ 5 | 🐛 0 | 🌐 Go | 📅 2015-07-11 - Go Port of HTTPerf.rb.
...
* [WebP-detect](https://github.com/igrigorik/webp-detect) ⭐ 243 | 🐛 0 | 🌐 C++ | 📅 2018-10-05 - WebP with Accept negotiation.
...
For contributing, please check [contributing.md](contributing.md), then [open an issue](https://github.com/davidsonfellipe/awesome-wpo/issues) ⭐ 9,083 | 🐛 30 | 📅 2026-07-28 and/or a [pull request](https://github.com/davidsonfellipe/awesome-wpo/pulls) ⭐ 9,083 | 🐛 30 | 📅 2026-07-28.
