...
[![GitHub contributors](https://img.shields.io/github/contributors/davidsonfellipe/awesome-wpo.svg)](https://github.com/davidsonfellipe/awesome-wpo/graphs/contributors) ⭐ 9,062 | 🐛 25 | 📅 2026-07-28
...
* [web-quality-audit](https://github.com/addyosmani/web-quality-skills#web-quality-audit) ⭐ 2,742 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - Comprehensive quality review across all categories.
* [core-web-vitals](https://github.com/addyosmani/web-quality-skills#core-web-vitals) ⭐ 2,742 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - LCP, INP, and CLS specific optimizations.
* [accessibility](https://github.com/addyosmani/web-quality-skills#accessibility) ⭐ 2,742 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - WCAG compliance, screen reader support, and keyboard navigation.
* [performance](https://github.com/addyosmani/web-quality-skills#performance) ⭐ 2,742 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - Loading speed, runtime efficiency, and resource optimization.
* [best-practices](https://github.com/addyosmani/web-quality-skills#best-practices) ⭐ 2,742 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - Security, modern APIs, and code quality patterns.
...
* [source-map-explorer](https://github.com/danvk/source-map-explorer) ⭐ 3,934 | 🐛 57 | 🌐 TypeScript | 📅 2023-03-14 - Analyze and debug bundle space usage through source maps.
...
* [BundleStats](https://github.com/relative-ci/bundle-stats) ⭐ 672 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-03 - Generate bundle report(bundle size, assets, modules, packages) and compare the results between different builds.
...
* [Stats.js](https://github.com/mrdoob/stats.js) ⭐ 9,153 | 🐛 22 | 🌐 JavaScript | 📅 2024-10-11 - This class provides a simple info box that will help you monitor your code performance.
...
* [jsDelivr](https://github.com/jsdelivr/jsdelivr) ⭐ 6,354 | 🐛 31 | 🌐 JavaScript | 📅 2026-06-27 - Similar to Google Hosted Libraries, jsDelivr is an open-source CDN that allows developers to host their own projects and anyone to link to our hosted files on their sites.
...
* [Lighthouse](https://github.com/GoogleChrome/lighthouse) ⭐ 30,729 | 🐛 457 | 🌐 JavaScript | 📅 2026-09-03 - Audits Core Web Vitals in lab conditions (see [Analyzers](#analyzers)).
* [web-vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,604 | 🐛 14 | 🌐 JavaScript | 📅 2026-08-26 - Small library to accurately measure Core Web Vitals (LCP, FID, CLS, INP, TTFB) in the browser.
* [Lighthouse CI](https://github.com/GoogleChrome/lighthouse-ci) ⭐ 7,071 | 🐛 234 | 🌐 JavaScript | 📅 2026-03-27 - Run Lighthouse in CI to enforce Core Web Vitals budgets on every commit.
...
* [Sharp](https://github.com/lovell/sharp) ⭐ 32,627 | 🐛 116 | 🌐 JavaScript | 📅 2026-08-30 - The typical use case for this high-speed Node.js module is to convert large images of many formats to smaller, web-friendly JPEG, PNG, and WebP images of varying dimensions.
...
* [mozjpeg](https://github.com/mozilla/mozjpeg) ⭐ 5,721 | 🐛 102 | 🌐 C | 📅 2025-06-23 - Improved JPEG encoder.
...
* [Optimizt](https://github.com/343dev/optimizt) ⭐ 184 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-02 - CLI image optimization tool. It can compress PNG, JPEG, GIF and SVG lossy and lossless, and also create AVIF and WebP versions for raster images.
...
* [quicklink](https://github.com/GoogleChromeLabs/quicklink) ⭐ 11,277 | 🐛 36 | 🌐 JavaScript | 📅 2026-09-01 - Prefetch links in the viewport (via Intersection Observer) to make future navigations faster.
...
* [Guess.js](https://github.com/guess-js/guess) ⭐ 7,119 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-02 - Predictive prefetching and performance optimization using analytics and machine learning.
...
* [Telescope](https://github.com/cloudflare/telescope) ⭐ 303 | 🐛 58 | 🌐 TypeScript | 📅 2026-09-03 - Cross-browser web performance testing CLI and library built on Playwright; collects HAR, Web Vitals, resource timing, console logs, screenshots, and filmstrip across Chrome, Firefox, Safari, and Edge.
...
* [Clean-css](https://github.com/clean-css/clean-css) ⭐ 4,201 | 🐛 45 | 🌐 JavaScript | 📅 2024-10-18 - A fast, efficient, and well-tested CSS minifier for node.js.
...
* [JShrink](https://github.com/tedious/JShrink) ⭐ 763 | 🐛 14 | 🌐 PHP | 📅 2025-11-20 - PHP class that minifies JavaScript for faster delivery to the client.
...
* [react-virtualized](https://github.com/bvaughn/react-virtualized) ⭐ 27,080 | 🐛 0 | 🌐 JavaScript | 📅 2025-01-20 - React components for efficiently rendering large lists and tabular data by virtualizing visible rows.
...
* [Fontaine](https://github.com/unjs/fontaine) ⭐ 1,985 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-03 - Automatic font fallback based on font metrics to reduce Cumulative Layout Shift (CLS) caused by web font loading.
...
* [SVGO](https://github.com/svg/svgo) ⭐ 22,666 | 🐛 260 | 🌐 JavaScript | 📅 2026-08-27 - Node.js-based optimizer for SVG vector graphics.
...
For contributing, please check [contributing.md](contributing.md), then [open an issue](https://github.com/davidsonfellipe/awesome-wpo/issues) ⭐ 9,062 | 🐛 25 | 📅 2026-07-28 and/or a [pull request](https://github.com/davidsonfellipe/awesome-wpo/pulls) ⭐ 9,062 | 🐛 25 | 📅 2026-07-28.
