...
[![GitHub contributors](https://img.shields.io/github/contributors/davidsonfellipe/awesome-wpo.svg)](https://github.com/davidsonfellipe/awesome-wpo/graphs/contributors) ⭐ 9,060 | 🐛 22 | 📅 2026-07-28
...
* [web-quality-audit](https://github.com/addyosmani/web-quality-skills#web-quality-audit) ⭐ 2,727 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - Comprehensive quality review across all categories.
* [core-web-vitals](https://github.com/addyosmani/web-quality-skills#core-web-vitals) ⭐ 2,727 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - LCP, INP, and CLS specific optimizations.
* [accessibility](https://github.com/addyosmani/web-quality-skills#accessibility) ⭐ 2,727 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - WCAG compliance, screen reader support, and keyboard navigation.
* [performance](https://github.com/addyosmani/web-quality-skills#performance) ⭐ 2,727 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - Loading speed, runtime efficiency, and resource optimization.
* [best-practices](https://github.com/addyosmani/web-quality-skills#best-practices) ⭐ 2,727 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - Security, modern APIs, and code quality patterns.
...
* [BundleStats](https://github.com/relative-ci/bundle-stats) ⭐ 672 | 🐛 40 | 🌐 TypeScript | 📅 2026-08-31 - Generate bundle report(bundle size, assets, modules, packages) and compare the results between different builds.
...
* [jsDelivr](https://github.com/jsdelivr/jsdelivr) ⭐ 6,350 | 🐛 32 | 🌐 JavaScript | 📅 2026-06-27 - Similar to Google Hosted Libraries, jsDelivr is an open-source CDN that allows developers to host their own projects and anyone to link to our hosted files on their sites.
...
* [Lighthouse](https://github.com/GoogleChrome/lighthouse) ⭐ 30,714 | 🐛 461 | 🌐 JavaScript | 📅 2026-08-30 - Audits Core Web Vitals in lab conditions (see [Analyzers](#analyzers)).
...
* [Lighthouse CI](https://github.com/GoogleChrome/lighthouse-ci) ⭐ 7,061 | 🐛 234 | 🌐 JavaScript | 📅 2026-03-27 - Run Lighthouse in CI to enforce Core Web Vitals budgets on every commit.
...
* [Sharp](https://github.com/lovell/sharp) ⭐ 32,622 | 🐛 116 | 🌐 JavaScript | 📅 2026-08-30 - The typical use case for this high-speed Node.js module is to convert large images of many formats to smaller, web-friendly JPEG, PNG, and WebP images of varying dimensions.
...
* [Guess.js](https://github.com/guess-js/guess) ⭐ 7,119 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-30 - Predictive prefetching and performance optimization using analytics and machine learning.
...
* [Grunt-contrib-concat](https://github.com/gruntjs/grunt-contrib-concat) ⭐ 797 | 🐛 43 | 🌐 JavaScript | 📅 2026-06-23 - A Grunt plugin to concatenate files.
* [Grunt-contrib-cssmin](https://github.com/gruntjs/grunt-contrib-cssmin) ⭐ 789 | 🐛 28 | 🌐 JavaScript | 📅 2026-03-25 - CSS Minifier for Grunt.
...
* [Critical](https://github.com/addyosmani/critical) ⭐ 10,268 | 🐛 37 | 🌐 JavaScript | 📅 2026-08-03 - Extract & Inline Critical-path CSS in HTML pages (alpha).
* [Fontaine](https://github.com/unjs/fontaine) ⭐ 1,984 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-31 - Automatic font fallback based on font metrics to reduce Cumulative Layout Shift (CLS) caused by web font loading.
...
* [SVGO](https://github.com/svg/svgo) ⭐ 22,659 | 🐛 257 | 🌐 JavaScript | 📅 2026-08-27 - Node.js-based optimizer for SVG vector graphics.
...
* [wrk](https://github.com/wg/wrk) ⭐ 40,404 | 🐛 203 | 🌐 C | 📅 2023-12-30 - A HTTP benchmarking tool (with optional Lua scripting for request generation, response processing, and custom reporting).
...
For contributing, please check [contributing.md](contributing.md), then [open an issue](https://github.com/davidsonfellipe/awesome-wpo/issues) ⭐ 9,060 | 🐛 22 | 📅 2026-07-28 and/or a [pull request](https://github.com/davidsonfellipe/awesome-wpo/pulls) ⭐ 9,060 | 🐛 22 | 📅 2026-07-28.
