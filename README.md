...
[![GitHub contributors](https://img.shields.io/github/contributors/davidsonfellipe/awesome-wpo.svg)](https://github.com/davidsonfellipe/awesome-wpo/graphs/contributors) ⭐ 9,034 | 🐛 17 | 📅 2026-07-28
...
* [web-quality-audit](https://github.com/addyosmani/web-quality-skills#web-quality-audit) ⭐ 2,634 | 🐛 4 | 🌐 Shell | 📅 2026-06-14 - Comprehensive quality review across all categories.
* [core-web-vitals](https://github.com/addyosmani/web-quality-skills#core-web-vitals) ⭐ 2,634 | 🐛 4 | 🌐 Shell | 📅 2026-06-14 - LCP, INP, and CLS specific optimizations.
* [accessibility](https://github.com/addyosmani/web-quality-skills#accessibility) ⭐ 2,634 | 🐛 4 | 🌐 Shell | 📅 2026-06-14 - WCAG compliance, screen reader support, and keyboard navigation.
* [performance](https://github.com/addyosmani/web-quality-skills#performance) ⭐ 2,634 | 🐛 4 | 🌐 Shell | 📅 2026-06-14 - Loading speed, runtime efficiency, and resource optimization.
* [best-practices](https://github.com/addyosmani/web-quality-skills#best-practices) ⭐ 2,634 | 🐛 4 | 🌐 Shell | 📅 2026-06-14 - Security, modern APIs, and code quality patterns.
...
* [Webpack bundle analyzer](https://github.com/webpack/webpack-bundle-analyzer) ⭐ 12,660 | 🐛 26 | 🌐 JavaScript | 📅 2026-08-13 - Webpack plugin and CLI utility that represents bundle content as a convenient interactive zoomable treemap.
...
* [BundleStats](https://github.com/relative-ci/bundle-stats) ⭐ 671 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-18 - Generate bundle report(bundle size, assets, modules, packages) and compare the results between different builds.
...
* [Stats.js](https://github.com/mrdoob/stats.js) ⭐ 9,148 | 🐛 22 | 🌐 JavaScript | 📅 2024-10-11 - This class provides a simple info box that will help you monitor your code performance.
...
* [Lighthouse](https://github.com/GoogleChrome/lighthouse) ⭐ 30,668 | 🐛 455 | 🌐 JavaScript | 📅 2026-08-16 - Audits Core Web Vitals in lab conditions (see [Analyzers](#analyzers)).
...
* [Lighthouse CI](https://github.com/GoogleChrome/lighthouse-ci) ⭐ 7,049 | 🐛 233 | 🌐 JavaScript | 📅 2026-03-27 - Run Lighthouse in CI to enforce Core Web Vitals budgets on every commit.
...
* [Sharp](https://github.com/lovell/sharp) ⭐ 32,577 | 🐛 115 | 🌐 JavaScript | 📅 2026-08-13 - The typical use case for this high-speed Node.js module is to convert large images of many formats to smaller, web-friendly JPEG, PNG, and WebP images of varying dimensions.
...
* [Imager](http://github.com/imager-io/imager) ⭐ 728 | 🐛 8 | 🌐 Rust | 📅 2021-04-18 - Automated image compression for efficiently distributing images on the web.
...
* [quicklink](https://github.com/GoogleChromeLabs/quicklink) ⭐ 11,265 | 🐛 35 | 🌐 JavaScript | 📅 2026-08-10 - Prefetch links in the viewport (via Intersection Observer) to make future navigations faster.
...
* [Guess.js](https://github.com/guess-js/guess) ⭐ 7,118 | 🐛 31 | 🌐 TypeScript | 📅 2026-08-14 - Predictive prefetching and performance optimization using analytics and machine learning.
...
* [Phantomas](https://github.com/macbre/phantomas) ⭐ 2,260 | 🐛 66 | 🌐 JavaScript | 📅 2026-08-17 - PhantomJS-based web performance metrics collector and monitoring tool.
...
* [Telescope](https://github.com/cloudflare/telescope) ⭐ 299 | 🐛 58 | 🌐 TypeScript | 📅 2026-08-17 - Cross-browser web performance testing CLI and library built on Playwright; collects HAR, Web Vitals, resource timing, console logs, screenshots, and filmstrip across Chrome, Firefox, Safari, and Edge.
...
* [CSSO](https://github.com/css/csso) ⭐ 3,787 | 🐛 102 | 🌐 JavaScript | 📅 2024-06-21 - CSS minimizer unlike others. In addition to usual minification techniques, it can perform structural optimization of CSS files, resulting in smaller file size compared to other minifiers.
...
* [Fontaine](https://github.com/unjs/fontaine) ⭐ 1,979 | 🐛 41 | 🌐 TypeScript | 📅 2026-08-17 - Automatic font fallback based on font metrics to reduce Cumulative Layout Shift (CLS) caused by web font loading.
* [TMI](https://github.com/addyosmani/tmi) ⭐ 1,616 | 🐛 6 | 🌐 JavaScript | 📅 2017-02-14 - Too Many Images: discover your image weight on the web.
...
* [SVGO](https://github.com/svg/svgo) ⭐ 22,634 | 🐛 256 | 🌐 JavaScript | 📅 2026-08-16 - Node.js-based optimizer for SVG vector graphics.
...
For contributing, please check [contributing.md](contributing.md), then [open an issue](https://github.com/davidsonfellipe/awesome-wpo/issues) ⭐ 9,034 | 🐛 17 | 📅 2026-07-28 and/or a [pull request](https://github.com/davidsonfellipe/awesome-wpo/pulls) ⭐ 9,034 | 🐛 17 | 📅 2026-07-28.
