...
[![GitHub contributors](https://img.shields.io/github/contributors/davidsonfellipe/awesome-wpo.svg)](https://github.com/davidsonfellipe/awesome-wpo/graphs/contributors) ⭐ 9,065 | 🐛 28 | 📅 2026-07-28
...
* [web-quality-audit](https://github.com/addyosmani/web-quality-skills#web-quality-audit) ⭐ 2,764 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - Comprehensive quality review across all categories.
* [core-web-vitals](https://github.com/addyosmani/web-quality-skills#core-web-vitals) ⭐ 2,764 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - LCP, INP, and CLS specific optimizations.
* [accessibility](https://github.com/addyosmani/web-quality-skills#accessibility) ⭐ 2,764 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - WCAG compliance, screen reader support, and keyboard navigation.
* [performance](https://github.com/addyosmani/web-quality-skills#performance) ⭐ 2,764 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - Loading speed, runtime efficiency, and resource optimization.
* [best-practices](https://github.com/addyosmani/web-quality-skills#best-practices) ⭐ 2,764 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - Security, modern APIs, and code quality patterns.
...
* [Webpack bundle analyzer](https://github.com/webpack/webpack-bundle-analyzer) ⭐ 12,657 | 🐛 27 | 🌐 JavaScript | 📅 2026-08-28 - Webpack plugin and CLI utility that represents bundle content as a convenient interactive zoomable treemap.
* [Bundlesize](https://github.com/siddharthkp/bundlesize) ⭐ 4,471 | 🐛 83 | 🌐 JavaScript | 📅 2026-07-29 - Keep your bundle size in check.
...
* [BundleStats](https://github.com/relative-ci/bundle-stats) ⭐ 672 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-08 - Generate bundle report(bundle size, assets, modules, packages) and compare the results between different builds.
...
* [Lighthouse](https://github.com/GoogleChrome/lighthouse) ⭐ 30,744 | 🐛 465 | 🌐 JavaScript | 📅 2026-09-06 - Audits Core Web Vitals in lab conditions (see [Analyzers](#analyzers)).
...
* [Lighthouse CI](https://github.com/GoogleChrome/lighthouse-ci) ⭐ 7,074 | 🐛 234 | 🌐 JavaScript | 📅 2026-03-27 - Run Lighthouse in CI to enforce Core Web Vitals budgets on every commit.
...
* [Sharp](https://github.com/lovell/sharp) ⭐ 32,641 | 🐛 117 | 🌐 JavaScript | 📅 2026-09-07 - The typical use case for this high-speed Node.js module is to convert large images of many formats to smaller, web-friendly JPEG, PNG, and WebP images of varying dimensions.
...
* [Jpegoptim](https://github.com/tjko/jpegoptim) ⭐ 1,812 | 🐛 12 | 🌐 C | 📅 2026-03-01 - Utility to optimize/compress JPEG files.
...
* [quicklink](https://github.com/GoogleChromeLabs/quicklink) ⭐ 11,284 | 🐛 37 | 🌐 JavaScript | 📅 2026-09-01 - Prefetch links in the viewport (via Intersection Observer) to make future navigations faster.
...
* [WebPageTest API Wrapper for Node.js](https://github.com/catchpoint/WebPageTest.api-nodejs) ⭐ 1,634 | 🐛 58 | 🌐 JavaScript | 📅 2024-12-03 - WebPageTest API Wrapper is an npm package that wraps WebPageTest API for Node.js as a module and a command-line tool.
* [Telescope](https://github.com/cloudflare/telescope) ⭐ 304 | 🐛 58 | 🌐 TypeScript | 📅 2026-09-03 - Cross-browser web performance testing CLI and library built on Playwright; collects HAR, Web Vitals, resource timing, console logs, screenshots, and filmstrip across Chrome, Firefox, Safari, and Edge.
...
* [Terser](https://github.com/terser/terser) ⭐ 9,330 | 🐛 356 | 🌐 JavaScript | 📅 2026-09-02 - Modern JavaScript minifier and compressor; successor to UglifyJS with ES6+ support.
...
* [Clean-css](https://github.com/clean-css/clean-css) ⭐ 4,199 | 🐛 45 | 🌐 JavaScript | 📅 2024-10-18 - A fast, efficient, and well-tested CSS minifier for node.js.
...
* [Fontaine](https://github.com/unjs/fontaine) ⭐ 1,985 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-07 - Automatic font fallback based on font metrics to reduce Cumulative Layout Shift (CLS) caused by web font loading.
...
* [SVGO](https://github.com/svg/svgo) ⭐ 22,665 | 🐛 261 | 🌐 JavaScript | 📅 2026-08-27 - Node.js-based optimizer for SVG vector graphics.
...
For contributing, please check [contributing.md](contributing.md), then [open an issue](https://github.com/davidsonfellipe/awesome-wpo/issues) ⭐ 9,065 | 🐛 28 | 📅 2026-07-28 and/or a [pull request](https://github.com/davidsonfellipe/awesome-wpo/pulls) ⭐ 9,065 | 🐛 28 | 📅 2026-07-28.
