...
[![GitHub contributors](https://img.shields.io/github/contributors/davidsonfellipe/awesome-wpo.svg)](https://github.com/davidsonfellipe/awesome-wpo/graphs/contributors) ⭐ 9,082 | 🐛 30 | 📅 2026-07-28
...
* [web-quality-audit](https://github.com/addyosmani/web-quality-skills#web-quality-audit) ⭐ 2,799 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - Comprehensive quality review across all categories.
* [core-web-vitals](https://github.com/addyosmani/web-quality-skills#core-web-vitals) ⭐ 2,799 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - LCP, INP, and CLS specific optimizations.
* [accessibility](https://github.com/addyosmani/web-quality-skills#accessibility) ⭐ 2,799 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - WCAG compliance, screen reader support, and keyboard navigation.
* [performance](https://github.com/addyosmani/web-quality-skills#performance) ⭐ 2,799 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - Loading speed, runtime efficiency, and resource optimization.
* [best-practices](https://github.com/addyosmani/web-quality-skills#best-practices) ⭐ 2,799 | 🐛 5 | 🌐 Shell | 📅 2026-08-24 - Security, modern APIs, and code quality patterns.
...
* [Yandex.Tank](https://github.com/yandex/yandex-tank) ⭐ 2,597 | 🐛 86 | 🌐 Python | 📅 2026-09-16 - An extensible open-source load testing tool for advanced Linux users which is especially good as a part of an automated load testing suite.
...
* [Webpack bundle analyzer](https://github.com/webpack/webpack-bundle-analyzer) ⭐ 12,655 | 🐛 26 | 🌐 JavaScript | 📅 2026-09-17 - Webpack plugin and CLI utility that represents bundle content as a convenient interactive zoomable treemap.
...
* [Compression Webpack plugin](https://github.com/webpack/compression-webpack-plugin) ⭐ 1,425 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-15 - Prepare compressed versions of assets to serve them with Content-Encoding.
...
* [jsDelivr](https://github.com/jsdelivr/jsdelivr) ⭐ 6,379 | 🐛 32 | 🌐 JavaScript | 📅 2026-06-27 - Similar to Google Hosted Libraries, jsDelivr is an open-source CDN that allows developers to host their own projects and anyone to link to our hosted files on their sites.
...
* [Lighthouse](https://github.com/GoogleChrome/lighthouse) ⭐ 30,791 | 🐛 463 | 🌐 JavaScript | 📅 2026-09-18 - Audits Core Web Vitals in lab conditions (see [Analyzers](#analyzers)).
* [web-vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,616 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-14 - Small library to accurately measure Core Web Vitals (LCP, FID, CLS, INP, TTFB) in the browser.
* [Lighthouse CI](https://github.com/GoogleChrome/lighthouse-ci) ⭐ 7,089 | 🐛 234 | 🌐 JavaScript | 📅 2026-03-27 - Run Lighthouse in CI to enforce Core Web Vitals budgets on every commit.
...
* [Assetgraph-sprite](https://github.com/assetgraph/assetgraph-sprite) ⭐ 36 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-17 - Assetgraph transform for auto-generating sprites based on the CSS dependency graph.
...
* [Sharp](https://github.com/lovell/sharp) ⭐ 32,692 | 🐛 123 | 🌐 JavaScript | 📅 2026-09-13 - The typical use case for this high-speed Node.js module is to convert large images of many formats to smaller, web-friendly JPEG, PNG, and WebP images of varying dimensions.
...
* [quicklink](https://github.com/GoogleChromeLabs/quicklink) ⭐ 11,293 | 🐛 38 | 🌐 JavaScript | 📅 2026-09-01 - Prefetch links in the viewport (via Intersection Observer) to make future navigations faster.
...
* [Guess.js](https://github.com/guess-js/guess) ⭐ 7,119 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-15 - Predictive prefetching and performance optimization using analytics and machine learning.
* [InstantClick](https://github.com/dieulot/instantclick) ⭐ 5,485 | 🐛 55 | 🌐 JavaScript | 📅 2018-06-06 - Preloads pages on hover so in-site links feel instant.
...
* [Phantomas](https://github.com/macbre/phantomas) ⭐ 2,260 | 🐛 65 | 🌐 JavaScript | 📅 2026-09-16 - PhantomJS-based web performance metrics collector and monitoring tool.
...
* [Terser](https://github.com/terser/terser) ⭐ 9,337 | 🐛 362 | 🌐 JavaScript | 📅 2026-09-13 - Modern JavaScript minifier and compressor; successor to UglifyJS with ES6+ support.
...
* [Lazysizes](https://github.com/aFarkas/lazysizes) ⭐ 17,714 | 🐛 209 | 🌐 JavaScript | 📅 2024-04-03 - High-performance lazy loader for images (responsive and normal), iframes, and scripts, that detects any visibility changes triggered through user interaction, CSS or JavaScript without configuration.
...
* [Fontaine](https://github.com/unjs/fontaine) ⭐ 1,990 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-17 - Automatic font fallback based on font metrics to reduce Cumulative Layout Shift (CLS) caused by web font loading.
...
* [SVGO](https://github.com/svg/svgo) ⭐ 22,677 | 🐛 272 | 🌐 JavaScript | 📅 2026-08-27 - Node.js-based optimizer for SVG vector graphics.
...
* [wrk](https://github.com/wg/wrk) ⭐ 40,407 | 🐛 203 | 🌐 C | 📅 2023-12-30 - A HTTP benchmarking tool (with optional Lua scripting for request generation, response processing, and custom reporting).
...
For contributing, please check [contributing.md](contributing.md), then [open an issue](https://github.com/davidsonfellipe/awesome-wpo/issues) ⭐ 9,082 | 🐛 30 | 📅 2026-07-28 and/or a [pull request](https://github.com/davidsonfellipe/awesome-wpo/pulls) ⭐ 9,082 | 🐛 30 | 📅 2026-07-28.
